...
namespace Drupal\enrope_private_message\Plugin\Block;
 ...
 *
 * @Block(
 *   id = "enrope_private_message_actions_block",
 *   admin_label = @Translation("Enrope Private Message Actions"),
 *   category =  @Translation("Private Message"),
 * )
 */
class EnropePrivateMessageActionsBlock extends BlockBase implements BlockPluginInterface, ContainerFactoryPluginInterface {
