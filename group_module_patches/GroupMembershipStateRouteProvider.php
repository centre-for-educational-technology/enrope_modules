 ...
 */
class GroupMembershipStateRouteProvider extends DefaultHtmlRouteProvider {
  ...
  protected function getEditFormRoute(EntityTypeInterface $entity_type) {
    if ($route = parent::getEditFormRoute($entity_type)) {
      ...
      $route->setDefault('_title_callback', '\Drupal\group\Entity\Controller\GroupMembershipStateController::editTitle');
      $route->setOption('parameters', ['group_type' => ['type' => 'entity:group_type']]);
      return $route;
    }
  }
  ...
  protected function getDeleteFormRoute(EntityTypeInterface $entity_type) {
    if ($route = parent::getDeleteFormRoute($entity_type)) {
      // @todo Remove title part when https://www.drupal.org/node/2827739 lands.
      $route->setDefault('_title_callback', '\Drupal\group\Entity\Controller\GroupMembershipStateController::deleteTitle');
      $route->setOption('parameters', ['group_type' => ['type' => 'entity:group_type']]);
      return $route;
    }
  }
  ...
  protected function getCollectionRoute(EntityTypeInterface $entity_type) {
    if ($route = parent::getCollectionRoute($entity_type)) {
      ...
      $route->setDefault('_title', 'Group membership states');
